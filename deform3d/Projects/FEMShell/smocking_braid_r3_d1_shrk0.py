...
if __name__ == "__main__":
    ...
    weight_pos = 0.01
    sim.add_garment_3D("input/final/braid/r3c3_2c.obj", Vector3d(0, 0, 0), Vector3d(1, 1, 1), \
            Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0)
    sim.initialize_garment()
    ## if comment add_constraint_file(): org C-IPC
    sim.add_constraint_file("input/final/braid/r3c3_refineH_shrk0.constraintInfo", weight_pos)
    ...
    # sim.load_frame("input/final/braid/r3c3_def2c.obj")
