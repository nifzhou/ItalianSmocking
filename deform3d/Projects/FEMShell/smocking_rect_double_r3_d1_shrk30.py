...
if __name__ == "__main__":
    ...
    weight_pos = 0.01
    sim.add_garment_3D("input/final/rect/double_row3_d1_2c.obj", Vector3d(0, 0, 0), Vector3d(1, 1, 1), \
            Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0)
    sim.initialize_garment()

    ## if comment add_constraint_file(): org C-IPC
    sim.add_constraint_file("input/final/rect/double_row3_d1_refineH_shrk30.constraintInfo", weight_pos)
    ...
    # sim.load_frame("input/final/rect/double_row3_d1_def2c.obj")
